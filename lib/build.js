 ...
 *
 * @public
 * @param {Array.<string>} dirs 查找目录
 * @param {string|Array.<string>} extnames 搜索文件的后缀名
 */
exports.refreshCombine = function (dirs, extnames) {
    var getEntries = require('./module').getEntries;
    var entris = [];
    dirs.forEach(function (dir) {
        entris = entris.concat(getEntries(dir, extnames));
    });
 ...
 *
 * @public
 * @param {Array.<string>} dirs 搜索目录
 * @param {string|Array.<string>} 搜索文件的后缀名
 */
exports.updateModuleVersion = function (dirs, extnames) {
    var getEntryModules = require('./module').getEntryModules;
    var findFiles = require('./util').findFiles;
    var moduleInfo = require('./module').getConfig();
    var files = [];
    var combine = moduleInfo.combine || {};

    dirs.forEach(function (dir) {
        files = files.concat(findFiles(dir, extnames));
    });
